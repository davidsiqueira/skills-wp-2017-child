...
function twentyseventeen_custom_header_setup() {
	...
	add_theme_support( 'custom-header', apply_filters( 'twentyseventeen_custom_header_args', array(
		'default-image'      => get_parent_theme_file_uri( '/assets/images/primavera-steps-default.jpg' ),
		'width'              => 2000,
		'height'             => 1200,
		'flex-height'        => true,
		'video'              => true,
	...
	register_default_headers( array(
		'default-image' => array(
			'url'           => '%s/assets/images/primavera-steps-default.jpg',
			'thumbnail_url' => '%s/assets/images/primavera-steps-default.jpg',
